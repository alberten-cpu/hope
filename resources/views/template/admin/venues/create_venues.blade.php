...
@section('content')
    ...
    <div class="content-header">
        <x-admin.title-and-breadcrumb title="Create Venues"
                                      breadcrumbs='{"Home":"admin.dashboard","User":"","Customer":"venue.index","Create Venues":""}'/>
        <!-- /.content-header -->

        <x-admin.ui.card-form title="Create Venue" form-route="venue.store" form-id="create_customer">
            <x-slot name="input">
                <div class="mb-3">
            ...
            <x-slot name="button">
                <x-admin.ui.button type="submit" btn-name="Submit" name="venue_submit" id="venue_submit"/>
            </x-slot>
